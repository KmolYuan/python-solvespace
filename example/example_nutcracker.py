...
if __name__ == '__main__':
    ...
    if sys.result == SLVS_RESULT_OKAY:
        print ("點座標：")
        print("P1({:.3f}, {:.3f}, {:.3f})".format(sys.get_param(7).val, sys.get_param(8).val, sys.get_param(2).val))
        print("P1(0.000 0.000 0.000)")
        print("P2({:.3f}, {:.3f}, {:.3f})".format(sys.get_param(9).val, sys.get_param(10).val, sys.get_param(2).val))
        print("P2(-0.400 1.450 0.000)")
        print("P3({:.3f}, {:.3f}, {:.3f})".format(sys.get_param(11).val, sys.get_param(12).val, sys.get_param(2).val))
        print("P4(1.390 0.000 0.000)\n")
        print("Min: ({:.3f})".format(Ansmin))
        print("Max: ({:.3f})".format(Ansmax))
    else:
