...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.label_2.setGeometry(QtCore.QRect(260, 150, 81, 21))
        ...
        self.Start_Piont = QtWidgets.QComboBox(Dialog)
        self.Start_Piont.setGeometry(QtCore.QRect(150, 180, 91, 25))
        self.Start_Piont.setObjectName("Start_Piont")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.Start_Piont.setWhatsThis(_translate("Dialog", "Start point for next link."))
