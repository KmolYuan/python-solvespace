...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.Point_list.setGeometry(QtCore.QRect(10, 100, 161, 161))
        self.Point_list.setObjectName("Point_list")
        self.Run_list = QtWidgets.QListWidget(Dialog)
        self.Run_list.setGeometry(QtCore.QRect(220, 100, 161, 161))
        ...
        self.progressBar.setGeometry(QtCore.QRect(10, 280, 371, 31))
