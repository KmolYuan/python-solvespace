...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.Extendable_Rod = QtWidgets.QTableWidget(self.Extendable_rod_tab)
        self.Extendable_Rod.setGeometry(QtCore.QRect(10, 10, 351, 131))
        self.Extendable_Rod.setEditTriggers(QtWidgets.QAbstractItemView.NoEditTriggers)
        self.Extendable_Rod.setObjectName("Extendable_Rod")
        self.Extendable_Rod.setColumnCount(5)
        self.Extendable_Rod.setRowCount(0)
        item = QtWidgets.QTableWidgetItem()
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/icons/spring.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        item.setIcon(icon7)
        self.Extendable_Rod.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.Extendable_Rod.setHorizontalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        self.Extendable_Rod.setHorizontalHeaderItem(2, item)
        item = QtWidgets.QTableWidgetItem()
        self.Extendable_Rod.setHorizontalHeaderItem(3, item)
        item = QtWidgets.QTableWidgetItem()
        self.Extendable_Rod.setHorizontalHeaderItem(4, item)
        self.Extendable_Rod.horizontalHeader().setDefaultSectionSize(80)
        self.Extendable_Rod.horizontalHeader().setMinimumSectionSize(70)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Extendable_Rod.setStatusTip(_translate("MainWindow", "All extendable rod will show here. Needs two point."))
        item = self.Extendable_Rod.horizontalHeaderItem(0)
        item.setText(_translate("MainWindow", "Name"))
        item = self.Extendable_Rod.horizontalHeaderItem(1)
        item.setText(_translate("MainWindow", "Start side"))
        item = self.Extendable_Rod.horizontalHeaderItem(2)
        item.setText(_translate("MainWindow", "End side"))
        item = self.Extendable_Rod.horizontalHeaderItem(3)
        item.setText(_translate("MainWindow", "Min"))
        item = self.Extendable_Rod.horizontalHeaderItem(4)
