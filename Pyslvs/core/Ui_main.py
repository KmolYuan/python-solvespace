...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(360, 10, 391, 551))
        ...
        self.verticalLayoutWidget_10.setGeometry(QtCore.QRect(10, 10, 335, 551))
        self.verticalLayoutWidget_10.setObjectName("verticalLayoutWidget_10")
        self.toolsLayout = QtWidgets.QVBoxLayout(self.verticalLayoutWidget_10)
        ...
        self.Entiteis_Point = QtWidgets.QTableWidget(self.verticalLayoutWidget_10)
        ...
        self.X_coordinate = QtWidgets.QDoubleSpinBox(self.verticalLayoutWidget_10)
        ...
        self.verticalLayout.addWidget(self.X_coordinate)
        ...
        self.Y_coordinate = QtWidgets.QDoubleSpinBox(self.verticalLayoutWidget_10)
        ...
        self.verticalLayout_3.addWidget(self.Y_coordinate)
        self.horizontalLayout.addLayout(self.verticalLayout_3)
        self.Point_add_button = QtWidgets.QPushButton(self.verticalLayoutWidget_10)
        ...
        self.toolsLayout.addLayout(self.pointLayout)
        ...
        self.Tab = QtWidgets.QTabWidget(self.verticalLayoutWidget_10)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.verticalLayoutWidget_4.setGeometry(QtCore.QRect(10, 10, 301, 121))
        self.verticalLayoutWidget_4.setObjectName("verticalLayoutWidget_4")
        self.linkLayout = QtWidgets.QVBoxLayout(self.verticalLayoutWidget_4)
        ...
        self.linkLayout.addWidget(self.Entiteis_Link)
        self.verticalLayoutWidget_5 = QtWidgets.QWidget(self.Entites)
        self.verticalLayoutWidget_5.setGeometry(QtCore.QRect(10, 140, 301, 91))
        self.verticalLayoutWidget_5.setObjectName("verticalLayoutWidget_5")
        self.chainLayout = QtWidgets.QVBoxLayout(self.verticalLayoutWidget_5)
        self.chainLayout.setContentsMargins(0, 0, 0, 0)
        self.chainLayout.setObjectName("chainLayout")
        self.Entiteis_Stay_Chain = QtWidgets.QTableWidget(self.verticalLayoutWidget_5)
        ...
        self.chainLayout.addWidget(self.Entiteis_Stay_Chain)
        icon4 = QtGui.QIcon()
        ...
        self.verticalLayoutWidget_8 = QtWidgets.QWidget(self.Simulate)
        self.verticalLayoutWidget_8.setGeometry(QtCore.QRect(10, 10, 311, 221))
        ...
        self.Drive_Shaft = QtWidgets.QTableWidget(self.verticalLayoutWidget_8)
        self.Drive_Shaft.setObjectName("Drive_Shaft")
        self.Drive_Shaft.setColumnCount(3)
        ...
        self.Drive_Shaft.horizontalHeader().setDefaultSectionSize(80)
        self.Drive_Shaft.horizontalHeader().setMinimumSectionSize(70)
        self.verticalLayout_2.addWidget(self.Drive_Shaft)
        self.verticalLayout_4 = QtWidgets.QVBoxLayout()
        self.verticalLayout_4.setObjectName("verticalLayout_4")
        self.Slider = QtWidgets.QTableWidget(self.verticalLayoutWidget_8)
        ...
        self.Slider.horizontalHeader().setDefaultSectionSize(80)
        self.Slider.horizontalHeader().setMinimumSectionSize(70)
        self.verticalLayout_4.addWidget(self.Slider)
        self.verticalLayout_2.addLayout(self.verticalLayout_4)
        self.verticalLayout_5.addLayout(self.verticalLayout_2)
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/icons/arc.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.Tab.addTab(self.Simulate, icon7, "")
        self.Style = QtWidgets.QWidget()
        self.Style.setObjectName("Style")
        self.verticalLayoutWidget_6 = QtWidgets.QWidget(self.Style)
        self.verticalLayoutWidget_6.setGeometry(QtCore.QRect(10, 10, 301, 151))
        ...
        self.verticalLayoutWidget_7 = QtWidgets.QWidget(self.Style)
        self.verticalLayoutWidget_7.setGeometry(QtCore.QRect(10, 170, 301, 24))
        self.verticalLayoutWidget_7.setObjectName("verticalLayoutWidget_7")
        self.styleTextLayout = QtWidgets.QVBoxLayout(self.verticalLayoutWidget_7)
        self.styleTextLayout.setContentsMargins(0, 0, 0, 0)
        self.styleTextLayout.setObjectName("styleTextLayout")
        self.label_4 = QtWidgets.QLabel(self.verticalLayoutWidget_7)
        self.label_4.setTextFormat(QtCore.Qt.RichText)
        self.label_4.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignTop)
        self.label_4.setObjectName("label_4")
        self.styleTextLayout.addWidget(self.label_4)
        self.horizontalLayoutWidget = QtWidgets.QWidget(self.Style)
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(10, 200, 301, 41))
        self.horizontalLayoutWidget.setObjectName("horizontalLayoutWidget")
        self.styleButtonLayout = QtWidgets.QHBoxLayout(self.horizontalLayoutWidget)
        self.styleButtonLayout.setContentsMargins(0, 0, 0, 0)
        self.styleButtonLayout.setObjectName("styleButtonLayout")
        self.Color_set = QtWidgets.QPushButton(self.horizontalLayoutWidget)
        self.Color_set.setObjectName("Color_set")
        self.styleButtonLayout.addWidget(self.Color_set)
        self.Repaint = QtWidgets.QPushButton(self.horizontalLayoutWidget)
        self.Repaint.setObjectName("Repaint")
        self.styleButtonLayout.addWidget(self.Repaint)
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/icons/char-3-radio-true.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.Tab.addTab(self.Style, icon8, "")
        self.tabLayout.addWidget(self.Tab)
        self.toolsLayout.addLayout(self.tabLayout)
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/icons/step-rotate.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_New_Workbook.setIcon(icon9)
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(":/icons/step-translate.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_Load_Workbook.setIcon(icon10)
        ...
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(":/icons/edges.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_Output_to_Script.setIcon(icon11)
        ...
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap(":/icons/kmol.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_Get_Help.setIcon(icon13)
        self.action_Get_Help.setObjectName("action_Get_Help")
        self.action_Prefenece = QtWidgets.QAction(MainWindow)
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap(":/icons/shaded.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_Prefenece.setIcon(icon14)
        self.action_Prefenece.setObjectName("action_Prefenece")
        self.actionGit_hub_Site = QtWidgets.QAction(MainWindow)
        icon15 = QtGui.QIcon()
        icon15.addPixmap(QtGui.QPixmap(":/icons/github-24.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionGit_hub_Site.setIcon(icon15)
        ...
        self.actionGithub_Wiki.setIcon(icon15)
        ...
        icon16 = QtGui.QIcon()
        icon16.addPixmap(QtGui.QPixmap(":/icons/char-0-check-false.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon16.addPixmap(QtGui.QPixmap(":/icons/char-1-check-true.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.action_Highlight_Drive_Shaft_Point.setIcon(icon16)
        ...
        icon17 = QtGui.QIcon()
        icon17.addPixmap(QtGui.QPixmap(":/icons/minmized.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionMi_nimized.setIcon(icon17)
        self.actionMi_nimized.setObjectName("actionMi_nimized")
        self.actionM_axmized = QtWidgets.QAction(MainWindow)
        icon18 = QtGui.QIcon()
        icon18.addPixmap(QtGui.QPixmap(":/icons/maxmized.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionM_axmized.setIcon(icon18)
        ...
        icon19 = QtGui.QIcon()
        icon19.addPixmap(QtGui.QPixmap(":/icons/fullscreen.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_Full_Screen.setIcon(icon19)
        self.action_Full_Screen.setObjectName("action_Full_Screen")
        self.actionNormalmized = QtWidgets.QAction(MainWindow)
        icon20 = QtGui.QIcon()
        icon20.addPixmap(QtGui.QPixmap(":/icons/normalsized.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionNormalmized.setIcon(icon20)
        self.actionNormalmized.setObjectName("actionNormalmized")
        self.action_Output_to_Picture = QtWidgets.QAction(MainWindow)
        icon21 = QtGui.QIcon()
        icon21.addPixmap(QtGui.QPixmap(":/icons/faces.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_Output_to_Picture.setIcon(icon21)
        ...
        icon22 = QtGui.QIcon()
        icon22.addPixmap(QtGui.QPixmap(":/icons/hidden-lines.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_Output_Coordinate_to_Text_File.setIcon(icon22)
        ...
        icon23 = QtGui.QIcon()
        icon23.addPixmap(QtGui.QPixmap(":/icons/angle.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_Angle_Simulation.setIcon(icon23)
        ...
        icon24 = QtGui.QIcon()
        icon24.addPixmap(QtGui.QPixmap(":/icons/other-supp.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionSimulation_Options.setIcon(icon24)
        ...
        icon25 = QtGui.QIcon()
        icon25.addPixmap(QtGui.QPixmap(":/icons/ref.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_See_Error_Logs.setIcon(icon25)
        ...
        icon26 = QtGui.QIcon()
        icon26.addPixmap(QtGui.QPixmap(":/icons/mesh.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_Appearance.setIcon(icon26)
        self.action_Appearance.setObjectName("action_Appearance")
        self.action_See_Python_Scripts = QtWidgets.QAction(MainWindow)
        self.action_See_Python_Scripts.setIcon(icon11)
        ...
        icon27 = QtGui.QIcon()
        icon27.addPixmap(QtGui.QPixmap(":/icons/delete.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionDelete_Point.setIcon(icon27)
        self.actionDelete_Point.setObjectName("actionDelete_Point")
        self.actionDelete_Linkage = QtWidgets.QAction(MainWindow)
        icon28 = QtGui.QIcon()
        icon28.addPixmap(QtGui.QPixmap(":/icons/deleteline.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionDelete_Linkage.setIcon(icon28)
        self.actionDelete_Linkage.setObjectName("actionDelete_Linkage")
        self.actionDelete_Stay_Chain = QtWidgets.QAction(MainWindow)
        icon29 = QtGui.QIcon()
        icon29.addPixmap(QtGui.QPixmap(":/icons/deletechain.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionDelete_Stay_Chain.setIcon(icon29)
        self.actionDelete_Stay_Chain.setObjectName("actionDelete_Stay_Chain")
        self.actionEdit_Point = QtWidgets.QAction(MainWindow)
        icon30 = QtGui.QIcon()
        icon30.addPixmap(QtGui.QPixmap(":/icons/editpoint.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionEdit_Point.setIcon(icon30)
        self.actionEdit_Point.setObjectName("actionEdit_Point")
        self.actionEdit_Linkage = QtWidgets.QAction(MainWindow)
        icon31 = QtGui.QIcon()
        icon31.addPixmap(QtGui.QPixmap(":/icons/length.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionEdit_Linkage.setIcon(icon31)
        self.actionEdit_Linkage.setObjectName("actionEdit_Linkage")
        self.actionEdit_Stay_Chain = QtWidgets.QAction(MainWindow)
        icon32 = QtGui.QIcon()
        icon32.addPixmap(QtGui.QPixmap(":/icons/editchain.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionEdit_Stay_Chain.setIcon(icon32)
        self.actionEdit_Stay_Chain.setObjectName("actionEdit_Stay_Chain")
        self.actionHow_to_use = QtWidgets.QAction(MainWindow)
        icon33 = QtGui.QIcon()
        icon33.addPixmap(QtGui.QPixmap(":/icons/assemble.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionHow_to_use.setIcon(icon33)
        self.actionHow_to_use.setObjectName("actionHow_to_use")
        self.actionSet_Slider = QtWidgets.QAction(MainWindow)
        self.actionSet_Slider.setIcon(icon6)
        ...
        MainWindow.setTabOrder(self.Entiteis_Link, self.X_coordinate)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Drive_Shaft.setStatusTip(_translate("MainWindow", "All simulate settings will show here."))
        ...
        self.Slider.setStatusTip(_translate("MainWindow", "All simulate settings will show here."))
        item = self.Slider.horizontalHeaderItem(0)
        item.setText(_translate("MainWindow", "Name"))
        item = self.Slider.horizontalHeaderItem(1)
        item.setText(_translate("MainWindow", "Silder Center"))
        ...
        self.actionSet_Slider.setStatusTip(_translate("MainWindow", "Set a point as a Slider center."))
